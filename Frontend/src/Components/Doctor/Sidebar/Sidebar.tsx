...
import { IconCalendarCheck, IconHeartbeat, IconLayoutGridFilled, IconMedicineSyrup, IconMoodHeart, IconStethoscope } from '@tabler/icons-react';
import { Avatar, Text } from '@mantine/core';
import { NavLink } from 'react-router-dom';
import { useSelector } from 'react-redux';

const links = [
    { label: 'Dashboard', url: '/doctor/dashboard', icon: <IconLayoutGridFilled stroke={1.5} />},
    { label: 'Profile', url: '/doctor/profile', icon: <IconHeartbeat stroke={1.5} />},
    { label: 'Patients', url: '/doctor/patients', icon: <IconMoodHeart stroke={1.5} />},
    { label: 'Appointments', url: '/doctor/appointments', icon: <IconCalendarCheck stroke={1.5} />},
    { label: 'Pharmacy', url: '/doctor/pharmacy', icon: <IconMedicineSyrup stroke={1.5} />}
