...
import { Card, Text, Skeleton, Group, Badge } from "@mantine/core";
...
const DiseaseChart = () => {
    ...
    useEffect(() => {
        ...
        countAllReasons()
            ...
            .catch((err) => console.error("Failed to load reason distribution:", err))
    ...
    // Define a vibrant color palette (matching the green theme)
    const chartColors = [
            ...
            <div className="disease-chart-wrapper">
                <div className="disease-chart-header">
                    <div className="disease-chart-header-left">
                        <span className="disease-chart-eyebrow">Analytics</span>
                ...
                <div className="disease-chart-content">
                    {loading ? (
                        ...
                        <div className="disease-chart-empty">
                            ...
                            <p className="disease-chart-empty-sub">No appointment reasons recorded yet.</p>
                        </div>
                    ) : (
                        <>
